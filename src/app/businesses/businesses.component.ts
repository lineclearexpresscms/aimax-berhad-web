...
export class BusinessesComponent {
  divisions = [
    { slug: 'gloves', title: 'Gloves & NBL Manufacturing', tagline: 'Becoming one of the notable glove makers in the nation', img: 'assets/images/Nitrile Glove.png', link: '/businesses/manufacturing' },
