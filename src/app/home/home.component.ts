...
export class HomeComponent {
  divisions = [
    { slug: 'gloves', title: 'Gloves & NBL Manufacturing', tagline: 'Becoming one of the notable glove makers in the nation', img: 'assets/images/HOMEPAGE-01.png', link: '/businesses/manufacturing' },
